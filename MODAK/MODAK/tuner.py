...
class Tuner:
    def __init__(self, upload=True):
        """Tuner class."""
        logger.info("Initialised MODAK tuner")
    ...
    #            logger.info("Successfully encoded tuner")
    #            return True
    #        else:
    #            logger.warning('unsupported tuning framework')
    #            return False
