...
## START OF TUNER ##
wget --no-check-certificate https://storage.googleapis.com/modak//modak/skyline-extraction-training_20200723224211_tune.sh

singularity exec docker:modakopt/modak:tensorflow-2.1-gpu-src skyline-extraction-training_20200723224211_tune.sh
## END OF TUNER ##
