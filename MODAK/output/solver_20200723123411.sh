...
## START OF TUNER ##
wget --no-check-certificate https://www.dropbox.com/s/pomwmcd25xbtz58/solver_20200723123411_tune.sh

singularity exec ethcscs/mpich:ub1804_cuda101_mpi314_gnugprof solver_20200723123411_tune.sh
## END OF TUNER ##
